...
def get_loggers():
    ...
    extensive_log_file_handler = logging.FileHandler(
        extensive_log_file, mode='a', encoding="utf-8")
    ...
    simple_log_file_handler = logging.FileHandler(
        simple_log_file, mode='a', encoding="utf-8")
